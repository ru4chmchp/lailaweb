                ...
                <li class="nav-item dropdown mega-dropdown ">
                    ...
                    <div class="dropdown-menu mega-menu v-2 row z-depth-1 white"
                        ...
                        <div class="row mx-md-4 mx-1">
                            @foreach ($value->categoryChil as $valueChil)
                                
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-5 mb-4">
                                
                                <h6 class="sub-title"><a href="{{ route('category.product',['slug' => $valueChil->slug, 'id' => $valueChil->id]) }}" class="text-uppercase font-weight-bold blue-text">{{ $valueChil->name }}</a></h6>
                    ...
                    <div class="dropdown-menu mega-menu v-2 row z-depth-1 white"
                        ...
                        <div class="row mx-md-4 mx-1">
                            ...
                            <div class="col-md-12 col-lg-4 sub-menu my-lg-5 mt-5 mb-4">
                                ...
                                <h4 class="mb-2"><a class="news-title-2 pl-0" href="">Lorem ipsum dolor
                                        sit</a></h4>
                            ...
                            <div class="col-md-6 col-lg-4 sub-menu my-lg-5 my-4">
                                ...
                                <ul class="caret-style pl-0">
                                    ...
                                    <li class=""><a class="menu-item" href="">Excepteur sint</a>
                                    </li>

                                    <li class=""><a class="menu-item" href="">Sunt in culpa</a></li>

                                    <li class=""><a class="menu-item" href="">Sed ut
                                            perspiciatis</a></li>

                                    <li class=""><a class="menu-item" href="">Mollit anim id est</a>
                                    </li>

                                    <li class=""><a class="menu-item" href="">Accusantium
                                            doloremque</a></li>
                        ...
                        <div class="row mx-md-4 mx-1">
                            ...
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-md-5 mt-4 mb-4">
                                ...
                                <p class="font-small text-uppercase dark-grey-text"><i class="far fa-clock-o pr-2"
                                    ...
                                    17, 2017 / <i class="far fa-comments px-1" aria-hidden="true"></i> 20</p>
                            ...
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-4 mb-4">
                                ...
                                <h4 class="mb-2"><a class="news-title-2 pl-0" href="">Ut labore et
                                        dolore magna</a></h4>

                                <p class="font-small text-uppercase dark-grey-text"><i class="far fa-clock-o pr-2"
                                        aria-hidden="true"></i>July

                                    16, 2017 / <i class="far fa-comments px-1" aria-hidden="true"></i> 25</p>
                            ...
                            <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-4 mb-5">
                                ...
                                <ul class="caret-style pl-0">
                                    ...
                                    <li class=""><a class="menu-item" href="">Totam rem aperiam
                                            eaque</a></li>

                                    <li class=""><a class="menu-item" href="">Beatae vitae dicta
                                            sun</a></li>

                                    <li class=""><a class="menu-item" href="">Quae ab illo
                                            inventore</a></li>

                                    <li class=""><a class="menu-item" href="">Nemo enim ipsam</a>
                                    </li>

                                    <li class=""><a class="menu-item" href="">Neque porro quisquam
                                            est</a></li>
