...
@section('content')
    <div class="content-wrapper">
        @include('layouts.admin-layouts.content-header', ['name' => 'Newsletters', 'key' => ''])
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{ route('newsletters.create') }}" class="btn btn-success float-right m-2">Add</a>
                    </div>
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">Tên Newsletter</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" class="btn btn-danger action_delete"
                                                data-url="{{ route('newsletters.delete', ['id' => $value->id]) }}">Xóa</a>
                                            <a href="{{ route('newsletters.edit', ['id' => $value->id]) }}"
